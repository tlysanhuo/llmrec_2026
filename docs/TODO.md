...
- [x] 完成I-17低剂量窗口：W&B `pfjlvm70` 200/200正常完成；从原始I-10 E3重新开始，未使用I-16 checkpoint。step100/150/200均过量化门槛，按最早全通过选step100；推荐聚合raw win 32.03%→43.36%、gold平均token logp下降0.00327、action保持93.75%，itemic断裂0/60。严格两文件包已验收但未上传；本地门禁不作线上估分。
