...
- “最高干净模型”必须分口径：最高无参数拼接的已评测单adapter是I-10 E3（旧协议0.9849，但含164条官方来源派生teacher行）；最严格纯O1、无teacher/融合的是I-14 E3（固定协议0.9518）。I-17尚未线上评测，不能称为更高分模型。
- I-16/I-17完成推荐金标排序DPO剂量搜索。I-16的step200/400/600均因gold-logp保护线失败而本地否决；I-17重新从I-10 E3启动，只降低更新积分，step100/150/200全部过量化门槛，按预注册选最早step100。step100推荐聚合raw win从32.03%升到43.36%、gold平均token logp仅下降0.00327、action保持93.75%、itemic断裂0/60；严格两文件包已生成但未上传。该holdout被自适应复用，以上只证明机制和灾难安全，不预测线上分数。
